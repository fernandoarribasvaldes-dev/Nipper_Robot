...
class MultiTurretKinematics(Node):
    ...
    def control_step(self):
        ...
        for i, (vx_i, vy_i) in enumerate(v_turrets):
            ...
            # If pointing backwards (> 90° away), flip turret direction
            if abs(angle_wrap(raw_phi)) > math.pi/2:
                phi_des = angle_wrap(raw_phi + math.pi)   # flip heading
                v_bar = -v_bar                             # reverse wheel direction
            else:
                phi_des = raw_phi
